    ...
    <form method="post">
        <div class="row ">
            ...
            <div class="mb-3 col-md-5">
                ...
                <input type="text" name="apellido" class="form-control" id="apellido" placeholder="Escribe el apellido del cliente">
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col-md-5">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-4">
                ...
                <input type="text" name="cuil_cuit" class="form-control" id="cuil_cuit" placeholder="Ej. 20-12345678-9">
            </div>
            <div class="mb-3 col-md-3">
        ...
        <div class="row">
            <div class="mb-3 col-md-5">
                ...
                <input type="email" name="email" class="form-control" id="email" placeholder="Ej. ejemplo@correo.com">
            </div>
            <div class="mb-3 col-md-5 ">
                    ...
                    try {
                        ...
                        if (count($categoriasCliente) > 0) {
                            foreach ($categoriasCliente as $categoriaCliente) {
                                echo '<option value="' . $categoriaCliente->id . '">' . $categoriaCliente->nombre . '</option>';
                            }
                        } else {
